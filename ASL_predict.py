...
# Note: 10 goes after 1 because loading the model using the ImageDataGenerator
# loads the folders in alphabetical order
...
(170, 45), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
    ...
    cv2.putText(frame_copy, "ASL recognition",
